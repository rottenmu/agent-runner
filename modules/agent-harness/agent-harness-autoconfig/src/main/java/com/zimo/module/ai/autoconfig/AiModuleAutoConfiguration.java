...
public class AiModuleAutoConfiguration {
    ...
    public com.zimo.module.ai.plan.AiPlanAdminController aiPlanAdminController(
            org.springframework.beans.factory.ObjectProvider<com.zimo.starter.ai.AiAgentService> aiAgentServiceProvider) {
        com.zimo.starter.ai.AiAgentService svc = aiAgentServiceProvider.getIfAvailable();
        if (svc == null) {
            return null;
        }
    ...
    public com.zimo.module.ai.plugin.AiPluginAdminController aiPluginAdminController(
        ...
        com.zimo.starter.ai.plugin.DynamicPluginManager manager = pluginManagerProvider.getIfAvailable();
        if (manager == null) {
            return null;
        }
