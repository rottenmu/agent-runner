...
import com.zimo.starter.ai.sandbox.HttpRemoteSandboxBackend;
import com.zimo.starter.ai.sandbox.LocalSandboxBackend;
...
public class ToolsAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public com.zimo.starter.ai.sandbox.SandboxFileSystem sandboxFileSystem(
            ToolsProperties properties) {
        if (StringUtils.hasText(properties.getRemoteSandboxUrl())) {
            return new com.zimo.starter.ai.sandbox.HttpRemoteSandboxFileSystem(
                    properties.getRemoteSandboxUrl(),
                    properties.getRemoteSandboxToken(),
                    properties.getRemoteSandboxTimeoutSeconds());
        }
        return new com.zimo.starter.ai.sandbox.LocalSandboxFileSystem(
